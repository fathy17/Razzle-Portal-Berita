                                            ...
                                            <Fragment key={data.id}>
                                                ...
                                                <Grid item xs={12} sm={12} md={7} lg={7} xl={7} style={{padding: '12px', textAlign: 'start'}}>
                                                    ...
                                                    {data.acf.tag.map(item => {
                                                        return (
                                                            <Fragment key={item}>
                                                                <Link to={`/tags/${item}`} style={{ textDecoration: 'none' }}><button style={{ width: '70px', height: '25px', backgroundColor: '#EC9B3B', fontSize: '9px', color: 'white', textTransform: 'uppercase', fontWeight: '600', border: 'none', borderRadius: '3px', cursor: 'pointer', marginRight: '5px', marginTop: '2px' }}>{item}</button></Link>
                                                            </Fragment>
                                                        )
                                                    })}
                                                    </div>
